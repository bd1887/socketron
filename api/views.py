...
def oauth_redirect(request):
    ...
    oauth_url = f'https://id.twitch.tv/oauth2/token?client_id={settings.CLIENT_ID}&client_secret={settings.CLIENT_SECRET}&code={request_token}&grant_type=authorization_code&redirect_uri=http://localhost:3000/oauth/redirect'
